...
ggbootUV( data = ageTbl, 
  ...
  B = 1e4, altSide = 'high', eqErrBarWidth = TRUE, errBarLineType = "11", remXAxisMarks = TRUE, seB = 5e2, calcStat = "mean", trim = 0.2,
...
p0 = ggbootUV( data = full_join( lTbl0, lTbl1 ), 
  ...
  B = 1e4, altSide = 'high', eqErrBarWidth = TRUE, errBarLineType = "11", remXAxisMarks = FALSE, seB = 5e2, calcStat = "mean", trim = 0.2,
...
p0 = ggbootUV( data = full_join( lTbl0, lTbl1 ) %>% filter( vaccine != 8 ), 
  resp = resp, xAxis = vaccStim, col = vaccine, facet = infxn, pMethod = "percT", ciMethod = "bca",
  B = 1e5, altSide = 'high', eqErrBarWidth = TRUE, errBarLineType = "11", remXAxisMarks = FALSE, seB = 5e2, calcStat = "mean", trim = 0.2,
...
```{r 3.4-ag85-plot}
scaleFactor <- scaleFactor = 0.56^-1
p0 <- ggplot( fig34Tbl %>%
                 filter( timePoint == "0" &
